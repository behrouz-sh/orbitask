...
const SvgIconBookmarksMinus = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="currentColor" d="M12 11.75a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1 0-1.5z" />
    <path
      fill="currentColor"
      fillRule="evenodd"
...
export default SvgIconBookmarksMinus;
