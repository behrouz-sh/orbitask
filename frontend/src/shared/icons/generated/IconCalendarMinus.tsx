...
const SvgIconCalendarMinus = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="currentColor" d="M14.5 14.25a.75.75 0 0 1 0 1.5h-5a.75.75 0 0 1 0-1.5z" />
    <path
      fill="currentColor"
      fillRule="evenodd"
...
export default SvgIconCalendarMinus;
