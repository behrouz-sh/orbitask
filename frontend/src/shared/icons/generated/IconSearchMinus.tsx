...
const SvgIconSearchMinus = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="currentColor" d="M14 10.25a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1 0-1.5z" />
    <path
      fill="currentColor"
      fillRule="evenodd"
...
export default SvgIconSearchMinus;
