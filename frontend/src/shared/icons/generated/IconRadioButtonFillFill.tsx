...
const SvgIconRadioButtonFillFill = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="currentColor" d="M12 6a6 6 0 1 1 0 12 6 6 0 0 1 0-12" />
    <path
      fill="currentColor"
      fillRule="evenodd"
...
export default SvgIconRadioButtonFillFill;
