...
const SvgIconMinusSquare = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="currentColor" d="M15.5 11.25a.75.75 0 0 1 0 1.5h-7a.75.75 0 0 1 0-1.5z" />
    <path
      fill="currentColor"
      fillRule="evenodd"
...
export default SvgIconMinusSquare;
