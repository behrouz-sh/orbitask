...
const SvgIconListNumber = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path stroke="#303030" strokeLinecap="round" strokeWidth={1.5} d="M11 6h10m-10 6h10m-10 6h10" />
    <path
      stroke="#303030"
      strokeLinecap="round"
...
export default SvgIconListNumber;
