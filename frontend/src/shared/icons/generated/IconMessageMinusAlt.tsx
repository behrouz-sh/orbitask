...
const SvgIconMessageMinusAlt = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="currentColor" d="M15 9.75a.75.75 0 0 1 0 1.5H9a.75.75 0 0 1 0-1.5z" />
    <path
      fill="currentColor"
      fillRule="evenodd"
...
export default SvgIconMessageMinusAlt;
